...
|---|---|---|
| 色系 | 玫瑰粉 `#A83459` | 橘 `#A8410A` |
| 標誌 | 白粉漸層愛心 48×44 | 白橘漸層星星 58×55 |
| 標題列文字 | 白 | 白 |

先前試過亮黃與亮萊姆綠，兩者配白字只有 1.9:1 與 1.7:1，必須改用深色文字，
視覺上偏刺眼；橘色夠深，可以沿用與 `index.html` 相同的白字頁首。

標題列漸層 `#B84C07 → #A04206 → #883404`，白色標題對三個色階為 **5.15 / 6.41 / 8.27**。
副標預設是 `rgba(255,255,255,.82)`，混色後在最亮端只有 3.75:1，
因此 office 調高到 `.95`，得 **4.80 / 5.96 / 7.63**，全段達 WCAG AA。
